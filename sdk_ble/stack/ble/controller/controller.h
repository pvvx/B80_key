...
#define			BLT_EV_FLAG_ADV									0 // not used in current SDK
#define			BLT_EV_FLAG_ADV_DURATION_TIMEOUT				1 // end duration interval
#define			BLT_EV_FLAG_SCAN_RSP							2 // scan request from Master
#define			BLT_EV_FLAG_CONNECT								3 // responds to connect reqeust from Master and enters Conn state Slave role
#define			BLT_EV_FLAG_TERMINATE							4 // reason for disconnection
#define			BLT_EV_FLAG_LL_REJECT_IND		    			5 // encryption request
#define			BLT_EV_FLAG_RX_DATA_ABANDON						6 // RX fifo overflows
#define			BLT_EV_FLAG_PHY_UPDATE							7 // PHY is updated
#define			BLT_EV_FLAG_DATA_LENGTH_EXCHANGE				8 // exchange max data length
#define			BLT_EV_FLAG_GPIO_EARLY_WAKEUP					9 // woke up from sleep by GPIO
#define			BLT_EV_FLAG_CHN_MAP_REQ							10 // update current connection channel list
#define			BLT_EV_FLAG_CONN_PARA_REQ						11 // update current connection parameters
#define			BLT_EV_FLAG_CHN_MAP_UPDATE						12 // updated channel map
#define			BLT_EV_FLAG_CONN_PARA_UPDATE					13 // updated connection parameters
#define			BLT_EV_FLAG_SUSPEND_ENTER						14 // event before Slave enters suspend
#define			BLT_EV_FLAG_SUSPEND_EXIT						15 // after is woke up from suspend
